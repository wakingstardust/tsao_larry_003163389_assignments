...
public class ManageFacultyJPanel extends javax.swing.JPanel {
    ...
    ArrayList<FacultyProfile> faculty = business.getFacultyDirectory().getFacultyList();
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        populateTable();
        JOptionPane.showMessageDialog(this, "Faculty list refreshed");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        FacultyProfile newFaculty = business.getFacultyDirectory().newFacultyProfile(newPerson);
        business.getUserAccountDirectory().newUserAccount(newFaculty, username, password);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String facultyName = (String) tblFaculty.getValueAt(selectedRow, 0);
        business.getFacultyDirectory().removeFaculty(facultyName);
